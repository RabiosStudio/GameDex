...
open class AlertServiceMock: AlertService, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func presentAlert(title: String, description: String, type: AlertType) {
        addInvocation(.m_presentAlert__title_titledescription_descriptiontype_type(Parameter<String>.value(`title`), Parameter<String>.value(`description`), Parameter<AlertType>.value(`type`)))
		let perform = methodPerformValue(.m_presentAlert__title_titledescription_descriptiontype_type(Parameter<String>.value(`title`), Parameter<String>.value(`description`), Parameter<AlertType>.value(`type`))) as? (String, String, AlertType) -> Void
		perform?(`title`, `description`, `type`)
    }


    fileprivate enum MethodType {
        case m_presentAlert__title_titledescription_descriptiontype_type(Parameter<String>, Parameter<String>, Parameter<AlertType>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_presentAlert__title_titledescription_descriptiontype_type(let lhsTitle, let lhsDescription, let lhsType), .m_presentAlert__title_titledescription_descriptiontype_type(let rhsTitle, let rhsDescription, let rhsType)):
				var results: [Matcher.ParameterComparisonResult] = []
				...
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsDescription, rhs: rhsDescription, with: matcher), lhsDescription, rhsDescription, "description"))
        ...
        func intValue() -> Int {
            switch self {
            case let .m_presentAlert__title_titledescription_descriptiontype_type(p0, p1, p2): return p0.intValue + p1.intValue + p2.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_presentAlert__title_titledescription_descriptiontype_type: return ".presentAlert(title:description:type:)"
            }
        }
    }
    ...
    public struct Verify {
        ...
        public static func presentAlert(title: Parameter<String>, description: Parameter<String>, type: Parameter<AlertType>) -> Verify { return Verify(method: .m_presentAlert__title_titledescription_descriptiontype_type(`title`, `description`, `type`))}
    }
    ...
    public struct Perform {
        ...
        public static func presentAlert(title: Parameter<String>, description: Parameter<String>, type: Parameter<AlertType>, perform: @escaping (String, String, AlertType) -> Void) -> Perform {
            return Perform(method: .m_presentAlert__title_titledescription_descriptiontype_type(`title`, `description`, `type`), performs: perform)
        }
    }
