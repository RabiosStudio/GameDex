...
open class AppReviewServiceMock: AppReviewService, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestReview() {
        addInvocation(.m_requestReview)
		let perform = methodPerformValue(.m_requestReview) as? () -> Void
		perform?()
    }


    fileprivate enum MethodType {
        case m_requestReview

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestReview, .m_requestReview): return .match
            }
        }

        func intValue() -> Int {
            switch self {
            case .m_requestReview: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestReview: return ".requestReview()"
            }
        }
    }
    ...
    public struct Verify {
        ...
        public static func requestReview() -> Verify { return Verify(method: .m_requestReview)}
    }
    ...
    public struct Perform {
        ...
        public static func requestReview(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_requestReview, performs: perform)
        }
    }
...
open class ObjectManagementDelegateMock: ObjectManagementDelegate, Mock {
    ...
    open func edit() {
        addInvocation(.m_edit)
		let perform = methodPerformValue(.m_edit) as? () -> Void
		perform?()
    }

    open func delete() {
        addInvocation(.m_delete)
		let perform = methodPerformValue(.m_delete) as? () -> Void
		perform?()
    }
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_edit, .m_edit): return .match

            case (.m_delete, .m_delete): return .match
            default: return .none
            }
        }
        ...
        func intValue() -> Int {
            switch self {
            case .m_edit: return 0
            case .m_delete: return 0
            }
        }
        func assertionName() -> String {
            switch self {
    ...
    public struct Verify {
        ...
        public static func edit() -> Verify { return Verify(method: .m_edit)}
        public static func delete() -> Verify { return Verify(method: .m_delete)}
    }
    ...
    public struct Perform {
        ...
        public static func edit(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_edit, performs: perform)
        }
        public static func delete(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_delete, performs: perform)
        }
    }
